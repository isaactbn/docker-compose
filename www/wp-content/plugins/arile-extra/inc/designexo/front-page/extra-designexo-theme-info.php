...
<div class="container" >
	<div class="row">
				...
				?>
						<div class="col-lg-<?php if('Designexo' == $activate_theme || 'InteriorWP' == $activate_theme || 'Designexo Child Theme' == $activate_theme || 'Architects' == $activate_theme || 'Interior Dark' == $activate_theme){ echo '3'; } ?><?php if('Empresa' == $activate_theme){ echo '3'; } ?> col-md-6 col-xs-12">
