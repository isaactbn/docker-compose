...
2. Type in SpiceMag in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.

== Copyright ==

SpiceMag WordPress Theme, Copyright (c) 2021, ThemeArile
SpiceMag is distributed under the terms of the GNU GPLs
...
* Image for Screenshot Image, Credit CC0 Public Domain
  ...
  Source: https://pxhere.com/en/photo/500646

* Image for Page Header Background Image, Credit CC0 Public Domain
  License: CC0 1.0 Universal (CC0 1.0)
  License URL: https://pxhere.com/en/license
  Source: https://pxhere.com/en/photo/680900

* Image for Testimonial Background Image, Credit CC0 Public Domain
  License: CC0 1.0 Universal (CC0 1.0)
  License URL: https://pxhere.com/en/license
  Source: https://pxhere.com/en/photo/1003487

* Image for Blog, Credit CC0 Public Domain
  License: CC0 1.0 Universal (CC0 1.0)
  License URL: https://pxhere.com/en/license
...
= Version 1.1
* We have fixed the theme review issues.
